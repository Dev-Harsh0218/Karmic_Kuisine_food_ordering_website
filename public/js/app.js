...
function updateCart(item) {
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/updated-cart", item, {
    headers: {
...
//change order status
var trackers = document.querySelectorAll(".order-tracking");
var transfer_input = document.querySelector("#ordertransfer");
var order = transfer_input ? JSON.parse(transfer_input.value) : null;
function updateOrderTracker(order) {
  var conditionFulfilled = false;
  trackers.forEach(function (track) {
    var dataprop = track.dataset.status;
...
//socket
var socket = io();
_admin__WEBPACK_IMPORTED_MODULE_0___default()(socket);
// join
if (order) {
...
socket.on('orderUpdated', function (data) {
  var udpOrder = _objectSpread({}, order);
  udpOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_1___default()().format('llll');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfoobar"] = self["webpackChunkfoobar"] || [];
